...
def test_functions():
    ...
    for function in functions_to_test:
        try:
            retval = function()  # קריאה לפונקציה
            print(f"{function.__name__} returned: {retval}")  # הדפסת התוצאה
        except Exception as e:
            print(f"{function.__name__} raised an exception: {e}")  # טיפול בשגיאות
